...
def test_main_exits_cleanly_if_play_game_returns_none(monkeypatch, capsys, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr(
        ...
        lambda _state, _spec, adapter=None, verification_result=None, **_kwargs: None,
    )
...
def test_no_new_game_accepted_when_no_verification_has_run(monkeypatch, capsys, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr(
        ...
        [
            ...
            "start",
            "--workspace",
            str(tmp_path / "ws-no-vr-no-new-game"),
            "--project-type",
            "document",
            "--artifact-id",
            "main-document",
...
def test_no_new_game_accepted_when_verification_passed(monkeypatch, capsys, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr(
        ...
        [
            ...
            "start",
            "--workspace",
            str(tmp_path / "ws-vr-pass-no-new-game"),
            "--project-type",
            "coding",
            "--artifact-id",
            "main-codebase",
...
def test_no_new_game_rejected_when_verification_failed(monkeypatch, capsys, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr(
        ...
        [
            ...
            "start",
            "--workspace",
            str(tmp_path / "ws-vr-fail-no-new-game"),
            "--project-type",
            "coding",
            "--artifact-id",
            "main-codebase",
            "--goal",
            "Write a file with tests.",
            "--output",
            "output/project",
            "--language",
            "python",
...
def test_no_new_game_override_resets_after_leaf_game(monkeypatch, capsys, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr(
        ...
        [
            ...
            "start",
            "--workspace",
            str(tmp_path / "ws-override-reset"),
            "--project-type",
            "coding",
            "--artifact-id",
            "main-codebase",
...
def test_main_no_state_change_stops_loop_before_max_iterations(monkeypatch, capsys, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr(
        ...
        [
            ...
            "start",
            "--workspace",
            str(tmp_path / "ws-no-change-early"),
            "--project-type",
            "document",
            "--artifact-id",
            "main-document",
...
def test_main_no_state_change_after_prior_state_change_reports_state_changed_true(
    ...
    monkeypatch.setattr(
        ...
        [
            ...
            "start",
            "--workspace",
            str(tmp_path / "ws-change-then-no-change"),
            "--project-type",
            "document",
            "--artifact-id",
            "main-document",
...
def test_play_game_no_delta_retries_then_stops_on_no_new_game(monkeypatch, tmp_path: Path, capsys) -> None:
    ...
    monkeypatch.setattr(
        "baps.core.orchestration.play_game",
        lambda _s, _g, adapter=None, verification_result=None, **_kw: None,
    )
    monkeypatch.setattr("baps.core.orchestration.create_game", _mock_create_game)
    monkeypatch.setattr(
        "sys.argv",
