...
def testbuild_role_client_infers_backend_from_global_when_only_model_set (monkeypatch )->None :
    monkeypatch .delenv ("BAPS_RED_BACKEND",raising =False )
    monkeypatch .setenv ("BAPS_RED_MODEL","claude-haiku-4-5-20251001")
    monkeypatch .setenv ("BAPS_BACKEND","anthropic")
    monkeypatch .setenv ("ANTHROPIC_API_KEY","sk-ant-test")
...
def testbuild_role_client_uses_global_anthropic_model_when_only_backend_set (monkeypatch )->None :
...
def testresolve_backend_model_role_spec_backend_only_falls_back_to_spec_model (monkeypatch )->None :
    monkeypatch .delenv ("BAPS_RED_MODEL",raising =False )
    config =_make_run_config (
    spec_backend ="ollama",
    spec_model ="global-model",
