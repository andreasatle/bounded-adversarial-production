...
def test_play_game_referee_receives_gamespec_state_view_delta_and_red(
    monkeypatch,
) -> None:
...
def test_play_game_red_receives_gamespec_state_view_and_delta_state(
    monkeypatch,
) -> None:
...
def test_play_game_previous_feedback_on_retry_contains_red_and_referee(
    monkeypatch,
) -> None:
