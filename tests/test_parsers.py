...
def test_red_finding_optional_fields_parse_when_present() -> None:
    ...
    assert red.findings == (
        "section body is too short",
        "title duplicates existing section",
    )


def test_red_finding_defaults_when_optional_fields_absent() -> None:
    red, _ = parse_red_finding_json('{"disposition":"accept","rationale":"looks good"}')
