...
def main() -> None:
    ...
    print(f"update_applied={updated_state_1 is not None}")
    print(f"state_changed={before_1 != after_1}")
    ...
    print(f"update_proposal_produced={proposal_2 is not None}")
    print(f"update_applied={updated_state_2 is not None}")
    print(f"state_changed={before_2 != after_2}")
