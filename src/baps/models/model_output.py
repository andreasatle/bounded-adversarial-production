...
def _try_normalize(
    ...
    if _is_react_format(parsed):
        ...
        if rescued is not None:
            ...
            logger.debug(
                "%s: ReAct format detected but action_input is not a dict; retrying",
                context,
            )
...
def parse_model_output(
    ...
    *,
    ...
    1. Strip markdown fences and size-check (extract_json_candidate).
    ...
    normalized = extract_json_candidate(text)
