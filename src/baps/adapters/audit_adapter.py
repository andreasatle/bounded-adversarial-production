...
def _collect_source_files(source_path: Path, patterns: tuple[str, ...]) -> list[Path]:
            ...
            ToolDefinition(
                ...
                parameters={
                    ...
                    "properties": {
                        "artifact_id": {
                            "type": "string",
                            "description": "Target audit report artifact ID",
                        },
                        "title": {
                            "type": "string",
                            "description": "Concise vulnerability name",
                        },
                        "body": {
                            "type": "string",
            ...
            ToolDefinition(
                ...
                parameters={
                    ...
                    "properties": {
                        ...
                        "section_title": {
                            "type": "string",
                            "description": "Exact title of the finding to revise",
                        },
                        "new_body": {
                            "type": "string",
                            "description": "Revised finding body",
                        },
                    },
            ...
            ToolDefinition(
                ...
                parameters={
                    ...
                    "properties": {
                        ...
                        "file": {
                            "type": "string",
                            "description": "File or subsystem audited",
                        },
                        "rationale": {
                            "type": "string",
                            "description": (
