...
plugin :LanguagePlugin ,
    ...
    f"- Forbidden markers in content include: {', '.join (repr (m )for m in BLUE_CONTENT_FORBIDDEN_MARKERS )}.\n"
...
def render_coding_evaluation_supplement (verification_result :VerificationResult |None )->str :
